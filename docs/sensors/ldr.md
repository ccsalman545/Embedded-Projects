...
![Conceptual LDR photoresistor module pin reference](../../assets/illustrations/sensors/ldr.svg)

> **Quick decision:** choose this for **very low-cost light/dark detection**. It communicates over **Analog + digital threshold** and typical Indian retail pricing is **₹30–80** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Supply | 3.3–5 V |
| Typical price in India | ₹30–80 |
| Same-job alternative | BH1750 / photodiode |
| Primary technique | Photoconductive CdS resistance changes with illumination |
...
| `VCC` | power |
| `GND` | return |
| `AO` | light-dependent divider voltage |
| `DO` | threshold |

## How it works

Photoconductive CdS resistance changes with illumination. The module conditions or digitises that physical effect, then exposes it through Analog + digital threshold. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** night light, line follower calibration. It is a practical choice when very low-cost light/dark detection; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **LDR photoresistor module** | very low-cost light/dark detection | Verify calibration, operating range and module variant |
| **BH1750 / photodiode** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for night light, line follower calibration.
...
- Primary product/datasheet page: [learn.adafruit.com](https://learn.adafruit.com/photocells)
