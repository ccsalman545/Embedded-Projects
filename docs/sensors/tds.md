...
![Conceptual TDS / conductivity module pin reference](../../assets/illustrations/sensors/tds.svg)

> **Quick decision:** choose this for **water conductivity/TDS trend with temperature compensation**. It communicates over **Analog voltage** and typical Indian retail pricing is **₹650–1,500** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Supply | 3.3–5.5 V |
| Typical price in India | ₹650–1,500 |
| Same-job alternative | EC meter / pH sensor |
| Primary technique | AC conductivity measurement estimates dissolved ionic solids |
...
| `VCC` | power |
| `GND` | return |
| `AOUT` | conditioned probe signal |
| `probe` | conductivity electrodes |

## How it works

AC conductivity measurement estimates dissolved ionic solids. The module conditions or digitises that physical effect, then exposes it through Analog voltage. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** hydroponics, RO filter trend. It is a practical choice when water conductivity/TDS trend with temperature compensation; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **TDS / conductivity module** | water conductivity/TDS trend with temperature compensation | Verify calibration, operating range and module variant |
| **EC meter / pH sensor** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for hydroponics, RO filter trend.
...
- Primary product/datasheet page: [wiki.dfrobot.com](https://wiki.dfrobot.com/Gravity__Analog_TDS_Sensor___Meter_For_Arduino_SKU__SEN0244)
