...
![Conceptual Sound sensor MAX9814 pin reference](../../assets/illustrations/sensors/max9814.svg)

> **Quick decision:** choose this for **audio amplitude/envelope—not calibrated dB without calibration**. It communicates over **Analog voltage** and typical Indian retail pricing is **₹220–550** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Same-job alternative | INMP441 / SPL meter |
| Primary technique | Electret microphone with automatic-gain amplifier |
...
| `VDD` | power |
| `GND` | return |
| `OUT` | biased audio waveform |
| `GAIN/AR` | gain controls where exposed |

## How it works

Electret microphone with automatic-gain amplifier. The module conditions or digitises that physical effect, then exposes it through Analog voltage. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** clap detector, sound-reactive light, recorder front end. It is a practical choice when audio amplitude/envelope—not calibrated dB without calibration; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **Sound sensor MAX9814** | audio amplitude/envelope—not calibrated dB without calibration | Verify calibration, operating range and module variant |
| **INMP441 / SPL meter** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for clap detector, sound-reactive light, recorder front end.
...
- Primary product/datasheet page: [www.analog.com](https://www.analog.com/en/products/max9814.html)
