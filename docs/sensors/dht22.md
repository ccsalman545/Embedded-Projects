...
![Conceptual DHT22 / AM2302 pin reference](../../assets/illustrations/sensors/dht22.svg)

> **Quick decision:** choose this for **better range and accuracy than DHT11**. It communicates over **Single-wire digital** and typical Indian retail pricing is **₹220–450** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Supply | 3.3–6 V |
| Typical price in India | ₹220–450 |
| Same-job alternative | SHT31 / BME280 |
| Primary technique | Capacitive humidity and band-gap temperature sensing |
...
Capacitive humidity and band-gap temperature sensing. The module conditions or digitises that physical effect, then exposes it through Single-wire digital. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** greenhouse, HVAC logger, storage monitor. It is a practical choice when better range and accuracy than DHT11; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **DHT22 / AM2302** | better range and accuracy than DHT11 | Verify calibration, operating range and module variant |
| **SHT31 / BME280** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for greenhouse, HVAC logger, storage monitor.
