...
![Conceptual LIS3DH accelerometer pin reference](../../assets/illustrations/sensors/lis3dh.svg)

> **Quick decision:** choose this for **low-power motion and orientation events**. It communicates over **I²C / SPI** and typical Indian retail pricing is **₹250–650** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Same-job alternative | ADXL345 / MPU6050 |
...
**Useful for:** wearable, shipping shock recorder. It is a practical choice when low-power motion and orientation events; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **LIS3DH accelerometer** | low-power motion and orientation events | Verify calibration, operating range and module variant |
| **ADXL345 / MPU6050** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for wearable, shipping shock recorder.
...
- Primary product/datasheet page: [www.st.com](https://www.st.com/en/mems-and-sensors/lis3dh.html)
