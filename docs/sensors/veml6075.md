...
![Conceptual UV sensor VEML6075 pin reference](../../assets/illustrations/sensors/veml6075.svg)

> **Quick decision:** choose this for **relative UV index for outdoor projects**. It communicates over **I²C** and typical Indian retail pricing is **₹800–1,600** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Same-job alternative | VEML6070 / calibrated radiometer |
| Primary technique | UVA/UVB photodiodes with compensated UV-index calculation |
...
UVA/UVB photodiodes with compensated UV-index calculation. The module conditions or digitises that physical effect, then exposes it through I²C. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** sun exposure logger, UV lamp check. It is a practical choice when relative UV index for outdoor projects; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **UV sensor VEML6075** | relative UV index for outdoor projects | Verify calibration, operating range and module variant |
| **VEML6070 / calibrated radiometer** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for sun exposure logger, UV lamp check.
...
- Primary product/datasheet page: [www.vishay.com](https://www.vishay.com/docs/84304/veml6075.pdf)
