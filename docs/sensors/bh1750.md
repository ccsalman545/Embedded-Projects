...
![Conceptual BH1750 ambient light pin reference](../../assets/illustrations/sensors/bh1750.svg)

> **Quick decision:** choose this for **ambient illuminance in lux**. It communicates over **I²C** and typical Indian retail pricing is **₹100–250** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Supply | 2.4–3.6 V core; breakout often 3–5 V |
| Typical price in India | ₹100–250 |
| Same-job alternative | VEML7700 / LDR |
| Primary technique | Photodiode with spectral response and digital lux conversion |
...
Photodiode with spectral response and digital lux conversion. The module conditions or digitises that physical effect, then exposes it through I²C. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** auto-dimming, solar logger, lighting control. It is a practical choice when ambient illuminance in lux; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **BH1750 ambient light** | ambient illuminance in lux | Verify calibration, operating range and module variant |
| **VEML7700 / LDR** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for auto-dimming, solar logger, lighting control.
...
- Primary product/datasheet page: [rohmfs.rohm.com](https://rohmfs.rohm.com/en/products/databook/datasheet/ic/sensor/light/bh1750fvi-e.pdf)
