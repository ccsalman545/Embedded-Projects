...
![Conceptual Soil moisture probe pin reference](../../assets/illustrations/sensors/soil-moisture.svg)

> **Quick decision:** choose this for **rough soil wet/dry indication; corrodes if powered continuously**. It communicates over **Analog + digital threshold** and typical Indian retail pricing is **₹50–130** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Supply | 3.3–5 V |
| Typical price in India | ₹50–130 |
| Same-job alternative | capacitive soil sensor |
| Primary technique | Resistive conductivity measurement between exposed electrodes |
...
| `VCC` | power |
| `GND` | return |
| `AO` | wetness divider voltage |
| `DO` | threshold output |

## How it works

Resistive conductivity measurement between exposed electrodes. The module conditions or digitises that physical effect, then exposes it through Analog + digital threshold. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** plant alert, irrigation demonstrator. It is a practical choice when rough soil wet/dry indication; corrodes if powered continuously; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **Soil moisture probe** | rough soil wet/dry indication; corrodes if powered continuously | Verify calibration, operating range and module variant |
| **capacitive soil sensor** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for plant alert, irrigation demonstrator.
...
- Primary product/datasheet page: [learn.sparkfun.com](https://learn.sparkfun.com/tutorials/soil-moisture-sensor-hookup-guide)
