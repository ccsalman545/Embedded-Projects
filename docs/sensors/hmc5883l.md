...
![Conceptual HMC5883L magnetometer pin reference](../../assets/illustrations/sensors/hmc5883l.svg)

> **Quick decision:** choose this for **magnetic heading after calibration**. It communicates over **I²C** and typical Indian retail pricing is **₹180–450** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Same-job alternative | QMC5883L / LIS3MDL |
| Primary technique | Anisotropic magnetoresistive 3-axis field sensing |
...
Anisotropic magnetoresistive 3-axis field sensing. The module conditions or digitises that physical effect, then exposes it through I²C. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** compass, direction logger. It is a practical choice when magnetic heading after calibration; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **HMC5883L magnetometer** | magnetic heading after calibration | Verify calibration, operating range and module variant |
| **QMC5883L / LIS3MDL** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for compass, direction logger.
...
- Primary product/datasheet page: [www.analog.com](https://www.analog.com/en/products/hmc5883l.html)
