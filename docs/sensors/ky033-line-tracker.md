...
![Conceptual KY-033 line-tracking sensor pin reference](../../assets/illustrations/sensors/ky033-line-tracker.svg)

> **Quick decision:** choose this for **high-contrast line detection near the surface**. It communicates over **Analog + digital threshold** and typical Indian retail pricing is **₹50–130** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Same-job alternative | QTR reflectance array / camera |
| Primary technique | IR LED illumination and reflected-light phototransistor sensing |
...
| `VCC` | power |
| `GND` | return |
| `DO` | comparator reflectance state |
| `AO` | reflectance level if exposed |
| `potentiometer` | threshold adjust |

## How it works

IR LED illumination and reflected-light phototransistor sensing. The module conditions or digitises that physical effect, then exposes it through Analog + digital threshold. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** line-following robot, paper/object detection. It is a practical choice when high-contrast line detection near the surface; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **KY-033 line-tracking sensor** | high-contrast line detection near the surface | Verify calibration, operating range and module variant |
| **QTR reflectance array / camera** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for line-following robot, paper/object detection.
