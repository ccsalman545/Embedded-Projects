...
![Conceptual TCS34725 colour sensor pin reference](../../assets/illustrations/sensors/tcs34725.svg)

> **Quick decision:** choose this for **colour classification under controlled illumination**. It communicates over **I²C** and typical Indian retail pricing is **₹550–1,100** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Supply | 2.7–3.3 V |
| Typical price in India | ₹550–1,100 |
| Same-job alternative | APDS9960 / AS7341 |
| Primary technique | RGB-clear filtered photodiodes with ADC |
...
| `SCL` | clock |
| `INT` | interrupt |
| `LED` | illumination control (breakout) |

## How it works

RGB-clear filtered photodiodes with ADC. The module conditions or digitises that physical effect, then exposes it through I²C. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** colour sorter, LED calibration. It is a practical choice when colour classification under controlled illumination; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **TCS34725 colour sensor** | colour classification under controlled illumination | Verify calibration, operating range and module variant |
| **APDS9960 / AS7341** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for colour sorter, LED calibration.
...
- Primary product/datasheet page: [ams-osram.com](https://ams-osram.com/products/sensor-solutions/ambient-light-color-spectral-proximity-sensors/ams-tcs34725-color-sensor)
