...
![Conceptual TSL2591 light sensor pin reference](../../assets/illustrations/sensors/tsl2591.svg)

> **Quick decision:** choose this for **very low to bright-light measurement**. It communicates over **I²C** and typical Indian retail pricing is **₹650–1,300** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Same-job alternative | VEML7700 / BH1750 |
| Primary technique | Dual photodiodes (visible + IR) with programmable gain |
...
Dual photodiodes (visible + IR) with programmable gain. The module conditions or digitises that physical effect, then exposes it through I²C. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** astronomy logger, greenhouse, lux meter. It is a practical choice when very low to bright-light measurement; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **TSL2591 light sensor** | very low to bright-light measurement | Verify calibration, operating range and module variant |
| **VEML7700 / BH1750** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for astronomy logger, greenhouse, lux meter.
...
- Primary product/datasheet page: [ams-osram.com](https://ams-osram.com/products/sensor-solutions/ambient-light-color-spectral-proximity-sensors/ams-tsl2591-digital-light-sensor)
