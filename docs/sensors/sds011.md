...
![Conceptual SDS011 particulate matter pin reference](../../assets/illustrations/sensors/sds011.svg)

> **Quick decision:** choose this for **PM2.5 and PM10 monitoring**. It communicates over **UART** and typical Indian retail pricing is **₹1,600–3,200** (indicative, checked catalogue range on 17 July 2026; shipping, clones, probe and tax can change it).
...
| Supply | 5 V |
| Typical price in India | ₹1,600–3,200 |
| Same-job alternative | PMS5003 / SEN55 |
| Primary technique | Laser light-scattering particle measurement |
...
Laser light-scattering particle measurement. The module conditions or digitises that physical effect, then exposes it through UART. Treat raw readings as measurements requiring the stated calibration, warm-up, mounting and environmental controls.
...
**Useful for:** outdoor AQ node, DIY purifier feedback. It is a practical choice when PM2.5 and PM10 monitoring; it is not a substitute for a safety-, medical-, or revenue-grade instrument unless the complete product is designed, calibrated and certified for that purpose.
...
|---|---|---|
| **SDS011 particulate matter** | PM2.5 and PM10 monitoring | Verify calibration, operating range and module variant |
| **PMS5003 / SEN55** | you need a different accuracy, range, lifetime or interface | normally costs more or needs more integration |

## Advantages and limitations

**Advantages**
- Accessible module ecosystem and microcontroller support.
- Directly useful for outdoor AQ node, DIY purifier feedback.
...
- Primary product/datasheet page: [www.inovafitness.com](https://www.inovafitness.com/en/a/laser-pm2-5-sensor-sds011.html)
